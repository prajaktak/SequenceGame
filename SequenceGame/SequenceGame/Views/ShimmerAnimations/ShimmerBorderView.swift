    ...
    public var body: some View {
        ZStack {
            RoundedRectangle(cornerRadius: 0)
                ...
                .foregroundStyle(.clear.gradient)
            RoundedRectangle(cornerRadius: 0)
                .strokeBorder(style: StrokeStyle(lineWidth: shimmerBorderSettings.borderWidth,
                                                 lineCap: .round,
                                                 lineJoin: .round,
                                                 dash: shimmerBorderSettings.dashArray,
                                                 dashPhase: isMovingAround ? shimmerBorderSettings.dashPhasePositive : shimmerBorderSettings.dashPhaseNegative))
        ...
        .onAppear {
            withAnimation(.linear.speed(shimmerBorderSettings.animationDuration).repeatForever(autoreverses: false)) {
